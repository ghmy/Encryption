...
namespace Yoikkuygulamasi2019.Security
{
    internal static class RSAExtensions
    {
        ...
        internal static void FromXmlStringExt(this RSA rsa, string xmlString)
        {
            RSAParameters parameters = new RSAParameters();
        ...
        internal static string ToXmlStringExt(this RSA rsa, bool includePrivateParameters)
        {
            RSAParameters parameters = rsa.ExportParameters(includePrivateParameters);
        ...
        private class RSAParametersJson
        {
